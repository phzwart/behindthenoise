...
Our framework uses ensembles of lightweight, randomly-architected neural networks to denoise scientific images **and** quantify uncertainty—all without any labeled data. In the process, it uncovers meaningful spatial and chemical features buried in the noise.
...
- **Reveals latent structure** by clustering ensemble outputs, producing interpretable segmentation without any supervision.
